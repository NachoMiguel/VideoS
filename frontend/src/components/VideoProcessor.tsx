...
const VideoProcessor: React.FC<VideoProcessorProps> = ({
    ...
    try {
      ...
      switch (message.type) {
        ...
        case 'scenes':
          ...
          console.log('Scene analysis completed:', message.scenes.length, 'scenes')
          break
        ...
        case 'error':
          ...
          console.error('WebSocket processing error:', message.error)
  ...
  const startProcessing = async () => {
    ...
    try {
      ...
      console.log('Video processing started:', selectedFile?.name)
